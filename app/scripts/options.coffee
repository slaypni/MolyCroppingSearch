CONFIG_DESCRIPTIONS = [
    {name: 'do_search_on_new_tab', description: 'search on new tab'}
]

BINDING_DESCRIPTIONS = [
    {name: 'enter_select_mode', description: 'enter select mode'},
    {name: 'quit_select_mode', description: 'quit select mode'},
]
